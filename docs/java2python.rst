...
.. js:class:: org.cellprofiler.javascript.CPython
    ...
    .. js:function:: execute
         ...
         Use ``execute`` in place of ``exec`` to call Python from a *jtypes.javabridge*
...
.. autofunction:: jt.javabridge.create_jref
.. autofunction:: jt.javabridge.create_and_lock_jref
