 ...
 *
 * The CPython class manages an in-process C Python instance,
 * allowing Java code to execute and evaluate scripts.
 */
public class CPython
{
    ...
    public static class StackFrame
    {
        ...
        public StackFrame(String fileName, int lineNumber,
                          String functionName, String codeContext)
        {
    ...
    static
    {
        ...
        for ( String classPath : classPaths.split(pathSeparator) )
        {
            if ( classPath.toLowerCase().endsWith("cpython.jar") )
            {
                 ...
                 *
                 * https://stackoverflow.com/questions/15409223/
        ...
        // System.loadLibrary("java2cpython");  // <AK>: commented (not needed).
     ...
     * (synonym for CPython.exec() needed only for compatibility with old javabridge
     *  - because "exec" was a Python2 keyword).
     */
    public void execute(String script) throws WrappedException
    {
        this.exec(script, null, null);
    }
    ...
    public void execute(String script,
                        ...
                        Map<String, Object> globals) throws WrappedException
    {
        this.exec(script, locals, globals);
    }
     ...
     *  new CPython().exec("from jt import javabridge\n" +
     *                     "janswer = javabridge.JWrapper(answer)\n" +
     *                     "janswer.add(1 + 1)");
